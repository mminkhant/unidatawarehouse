...
<div class="container mt-5">
    <h1 class="text-center mb-4">Average Pass Rate and fail rate for Each Course Over All Years</h1>
    ...
    <table class="table table-bordered table-striped">
        ...
        <c:forEach var="data" items="${data}">
            <tr>
                ...
                <td>${data.averagePassRate}</td>
                <td>${data.averageFailRate}</td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
